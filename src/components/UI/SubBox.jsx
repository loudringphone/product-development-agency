        ...
        <div className="newsletter">
            ...
            <div className='sub__form'>
                <form autoComplete='off' onSubmit={subscribe} action="/" className="form">
                    ...
                    <input autoComplete="none" type="email" className="form__email" name="Email" id="Email" onInput={handleEmailInput} placeholder="Subscribe with your email address now!"/>
